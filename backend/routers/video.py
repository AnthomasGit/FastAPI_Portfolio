...
async def trigger_video_generation(
    ...
    try:
        video_id = await generate_video(
            ...
            first_frame_reference_id=data.first_frame_reference_id,
            last_frame_reference_id=data.last_frame_reference_id,
            driving_video_id=data.driving_video_id,
            ref_video_ids=data.ref_video_ids,
            ref_audio_ids=data.ref_audio_ids,
