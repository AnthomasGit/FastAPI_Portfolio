...
export function Storyboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {/* Tabs */}
      <Tabs defaultValue="storyboard" className="mb-6">
        <TabsList variant="line" className="border-b border-white/10 w-full justify-start rounded-none bg-transparent mb-6">
          <TabsTrigger value="storyboard" className="text-slate-400 data-active:text-cyan-300">Storyboard</TabsTrigger>
          <TabsTrigger value="characters" className="text-slate-400 data-active:text-emerald-300">Characters</TabsTrigger>
          <TabsTrigger value="locations" className="text-slate-400 data-active:text-amber-300">Locations</TabsTrigger>
          <TabsTrigger value="props" className="text-slate-400 data-active:text-purple-300">Props</TabsTrigger>
        </TabsList>
